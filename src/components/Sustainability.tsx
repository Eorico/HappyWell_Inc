import { ArrowRight, Leaf, Recycle, TreePine, Waves } from "lucide-react";
import { Button } from "@/components/ui/button";

const initiatives = [
  { icon: Leaf, label: "Carbon Neutral Goals" },
  { icon: Recycle, label: "Wastewater Recycling" },
  { icon: TreePine, label: "Watershed Protection" },
  { icon: Waves, label: "Water Conservation" },
];
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="font-heading text-4xl md:text-5xl font-bold text-primary-foreground mt-2 mb-6">
            Our corporate vision is as clear as water.
          </h2>
